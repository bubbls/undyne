...
! function() {
  ...
  /* --- howler.js <base href> patch --- */
(function() {
  function resolveBase(path) {
    try {
      var base = document.querySelector("base")?.href || window.location.href;
      return new URL(path, base).toString();
    } catch (e) {
      return path;
    }
  }
  var OriginalHowl = window.Howl;
  window.Howl = function(o) {
    if (o && o.src) {
      if (!Array.isArray(o.src)) o.src = [o.src];
      o.src = o.src.map(resolveBase);
    }
    return new OriginalHowl(o);
  };
